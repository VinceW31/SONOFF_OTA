...
const int Led = 13;
const int Relay = 12;
const int Ext_Sw = 4; //14 for Sonoff Basic, 04 for Sonoff Mini
...
void setup(){
  ...
  //Web Page Design
  webPage += "<h1 style='text-align:center;'>SONOFF 101</h1><h2 style='text-align:center;'>(fw ver 26)</h2><p style='text-align:center;'><a href=\"toggle\"><button style='font-size:170%;'>ON</button></a>&nbsp;&nbsp<a href=\"toggle\"><button style='font-size:170%;'>OFF</button></a></p><p style='text-align:center;'><button style='font-size:170%;'>STATUS</button></p>";  
  webPageON += "<h1 style='text-align:center;'>SONOFF 101</h1><h2 style='text-align:center;'>(fw ver 26)</h2><p style='text-align:center;'><a href=\"toggle\"><button style='font-size:170%;'>ON</button></a>&nbsp;&nbsp<a href=\"toggle\"><button style='font-size:170%;'>OFF</button></a></p><p style='text-align:center;'><button style='font-size:170%;background-color:lime;'>STATUS</button></a></p>";  
  webPageOFF += "<h1 style='text-align:center;'>SONOFF 101</h1><h2 style='text-align:center;'>(fw ver 26)</h2><p style='text-align:center;'><a href=\"toggle\"><button style='font-size:170%;'>ON</button></a>&nbsp;&nbsp<a href=\"toggle\"><button style='font-size:170%;'>OFF</button></a></p><p style='text-align:center;'><button style='font-size:170%;background-color:red;'>STATUS</button></a></p>"; 
