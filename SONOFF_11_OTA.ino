...
//Web Page Design
  webPage += "<h1>SONOFF 119 (fw ver 11)</h1><p><a href=\"on\"><button style='font-size:170%; position:left;'>ON</button></a>&nbsp;<a href=\"off\"><button style='font-size:170%; position:right;'>OFF</button></a></p>";  
