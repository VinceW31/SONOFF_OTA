...
//Web Page Design
  webPage += "<h1 style='text-align:center;'>SONOFF 128</h1><h2 style='text-align:center;'>(fw ver 14)</h2><p style='text-align:center;'><a href=\"on\"><button style='font-size:170%;'>ON</button></a>&nbsp;&nbsp<a href=\"off\"><button style='font-size:170%;'>OFF</button></a></p><p style='text-align:center;'><button style='font-size:170%;'>STATUS</button></p>";  
  webPageON += "<h1 style='text-align:center;'>SONOFF 128</h1><h2 style='text-align:center;'>(fw ver 14)</h2><p style='text-align:center;'><a href=\"on\"><button style='font-size:170%;'>ON</button></a>&nbsp;&nbsp<a href=\"off\"><button style='font-size:170%;'>OFF</button></a></p><p style='text-align:center;'><button style='font-size:170%;background-color:lime;'>STATUS</button></a></p>";  
  webPageOFF += "<h1 style='text-align:center;'>SONOFF 128</h1><h2 style='text-align:center;'>(fw ver 14)</h2><p style='text-align:center;'><a href=\"on\"><button style='font-size:170%;'>ON</button></a>&nbsp;&nbsp<a href=\"off\"><button style='font-size:170%;'>OFF</button></a></p><p style='text-align:center;'><button style='font-size:170%;background-color:red;'>STATUS</button></a></p>";  
